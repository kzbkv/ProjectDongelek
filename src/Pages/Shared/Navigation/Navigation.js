    ...
    const list = (
        ...
        >
            <List>
                ...
                <ListItem button>
                    <ListItemText>
                        <Link className={mobileNavItem} to='/products'>Catalog Cars</Link>
                    </ListItemText>
                </ListItem>
                <ListItem button>
                    <ListItemText>
            ...
            <Box sx={{ flexGrow: 1 }}>
                <AppBar position="static" color="secondary">
                    <Toolbar>
                        ...
                        <NavLink className={navItemContainer} to="/products" style={{ textDecoration: 'none', color: 'white' }}><Button color="inherit">Catalog Cars</Button></NavLink>

    ...
    return (
        <footer style={footerBg}>
            <Container>
                <Grid container spacing={3} sx={{ my: 3 }}>
                    <Grid item xs={12} sm={12} md={6} lg={3}>
                        <List sx={{ mt: 4, textAlign: 'center' }}>
                            <img style={{ width: '25%' }} src="https://i.ibb.co.com/bbTXfRL/koleso.jpg" alt="" />
                            <ListItemText>SF CAR</ListItemText>
                            <Typography sx={{ textAlign: 'justify' }} variant="body1">Our cars are not just transportation, they are a lifestyle. 
                            Cross the boundaries of comfort with our premium cars. Make your dreams come true with Kazbek Cars</Typography>
                        </List>
                    </Grid>
                    <Grid item xs={12} sm={12} md={6} lg={3}>
                        <List>
                    ...
                    <Grid item xs={12} sm={12} md={6} lg={3}>
                        <List>
                            ...
                            <ListItemText>Almaty <br />Улица Брусиловского, 163</ListItemText>
                        </List>
                ...
                <Typography sx={{ textAlign: 'center', py: 4 }} variant="subtitle2">Copyright &copy; {new Date().getFullYear()} All Rights Reserved by Kazbek Family</Typography>
            </Container>
        </footer>
    );
};
